...
using ScubaDiver.Demangle.Demangle.Core.Lib;
using ScubaDiver.Demangle.Demangle.Core.Services;

namespace ScubaDiver.Demangle.Demangle.Core.Machine
{
    /// <summary>
        ...
        where TMnemonic : struct
    {
        ...
        /// request the <see cref="ITestGenerationService"/> in order to generate
