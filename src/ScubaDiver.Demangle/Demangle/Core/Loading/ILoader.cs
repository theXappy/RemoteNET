...
using ScubaDiver.Demangle.Demangle.Core.Assemblers;
using ScubaDiver.Demangle.Demangle.Core.Configuration;
using ScubaDiver.Demangle.Demangle.Core.Scripts;

namespace ScubaDiver.Demangle.Demangle.Core.Loading
{
    /// <summary>
