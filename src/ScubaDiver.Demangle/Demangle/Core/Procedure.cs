...
using ScubaDiver.Demangle.Demangle.Core.Absyn;
using ScubaDiver.Demangle.Demangle.Core.Code;
using ScubaDiver.Demangle.Demangle.Core.Graphs;
using ScubaDiver.Demangle.Demangle.Core.Output;
...
namespace ScubaDiver.Demangle.Demangle.Core
{
    ...
    public class Procedure : ProcedureBase, IAddressable
	{
        ...
        /// <see cref="DefInstruction"/>s or <see cref="Code.Assignment"/>s
        /// into this block.
        /// </summary>
